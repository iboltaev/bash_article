...
<projects>/<project1>/reports/<run>/<report1>.json:            "table": "<table1>",
<projects>/<project1>/reports/<run>/<report1>.json:            "table": "<table2>",
<projects>/<project1>/reports/<run>/<report2>.json:            "table": "<table3>",
